...
/* Paging structures */ 
typedef struct __attribute__((aligned (4))) page_directory_entry {
    uint32_t p          : 1; 
    uint32_t r_w        : 1;
    uint32_t u_s        : 1; 
    uint32_t pwt        : 1; 
    ...
    uint32_t g          : 1; 
    uint32_t avl        : 3;
    uint32_t address_20    : 20;
    // address_20 for PS=0, will need to mask into this when PS = 1
} page_directory_entry;

/* Paging structures */ 
typedef struct __attribute__((aligned (4))) page_table_entry {
    uint32_t p          : 1; 
    uint32_t r_w        : 1;
    uint32_t u_s        : 1; 
    uint32_t pwt        : 1; 
